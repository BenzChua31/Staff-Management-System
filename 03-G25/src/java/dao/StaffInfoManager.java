...
public class StaffInfoManager {
    ...
    public void addStaff(String email, String fname, String lname, 
        ...
        st.executeUpdate("INSERT INTO ISDUSER.USERS(First_Name, Last_Name, Password, Email, PhoneNo, Date_Of_Birth, isCustomer, Active) "
                + "VALUES ('" + fname + "', '" + lname + "', '" + password + "', '" + email + "', '" + phoneNo + "', '" + DOB + "', FALSE, FALSE)");
        ...
        st.executeUpdate("INSERT INTO ISDUSER.STAFF(StaffID, Staff_Position, Staff_Salary, Staff_EmploymentDate, Permissions) "
                + "VALUES (" + staffID + ", '" + staffPosition + "', " + staffSalary + ", '" + staffEmploymentDate + "', '" + permissions + "')");
    }
    ...
    public void deleteStaff(String email) throws SQLException, Exception {
        ...
        if (rs.next()) {
            ...
            st.executeUpdate("DELETE FROM ISDUSER.ULOGS WHERE ULOGSID=" + staffID + "");
            st.executeUpdate("DELETE FROM ISDUSER.STAFF WHERE STAFFID=" + staffID + "");
