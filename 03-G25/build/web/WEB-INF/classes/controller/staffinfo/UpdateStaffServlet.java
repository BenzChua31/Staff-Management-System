...
public class UpdateStaffServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        if (!(pos.equals("Employee") || pos.equals("Supervisor") || pos.equals("Manager"))) {
            session.setAttribute("U_posErr", "Error: Incorrect Position! Employee, Supervisor, Manager");
            hasError=true;
        }
        ...
        if (hasError) {
            ...
            try {
                ...
                session.setAttribute("U_updateSuccess", "Staff Updated Succcessfully!");
                request.getRequestDispatcher("UpdateStaff.jsp").include(request, response);
            } catch (Exception e) {
