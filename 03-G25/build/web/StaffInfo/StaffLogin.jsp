...
<%-- 
    REMINDER: PLEASE UPDATE THE ADMIN'S RECORD IN THE DB TO "ACTIVE=FALSE" in order to login. Admin email='jarettthelegend@gmail.com'
               because if you exit the program without logging out, it will not set ACTIVE to FALSE in the database.

               UPDATE ISDUSER.USERS SET ACTIVE=FALSE WHERE EMAIL='jarettthelegend@gmail.com';
--%>
